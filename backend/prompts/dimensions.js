...
Produce a 180-220 word executive summary in plain text (no Markdown, no bullet symbols). Include:
• Overall Privacy Posture (High/Medium/Low + one-sentence justification)
• Three cross-cutting insights that explicitly reference the contributing agents
• Action Blueprint – three prioritized steps blending policy, comms, and technical mitigations, written as sentences separated by semicolons.

Write in polished English suitable for a CISO briefing, but keep the entire response as a single block of sentences without Markdown formatting.`,
};
